...
<head>
  ...
  <style>
    ...
    .site-header{display:flex;align-items:center;gap:12px;border-bottom:1px solid #E5E7EB;padding:12px 0;}
    ...
    .kicker{font-size:28px;font-weight:900;margin:6px 0 10px}

    .meta{display:grid;gap:10px;grid-template-columns:repeat(3,1fr);margin:14px 0}
    .meta-box{background:var(--field);border:1px solid var(--field-b);border-radius:14px;padding:12px 14px;text-align:center;font-weight:700;color:#243b53}
    ...
    .chip-input{background:#fff;border:1px solid var(--field-b);border-radius:14px;padding:12px 14px;font-size:16px}
    ...
    .cta{padding:14px 20px;border-radius:14px;background:var(--accent);color:var(--accent-ink);font-weight:800;border:none;cursor:pointer;box-shadow:0 6px 16px rgba(59,124,116,.35)}

    .side{background:var(--card);color:#fff;border-radius:18px;padding:18px;box-shadow:0 10px 28px rgba(0,0,0,.14)}
    ...
    .pill{padding:10px;border-radius:12px;border:1px solid #3b4f85;background:#0f2144;color:#e5ecff;font-weight:800;cursor:pointer}
    .pill.active{background:#25407a}

    .review{margin-top:10px}
    .review-title{font-weight:800;margin-bottom:6px}
    .reset{width:100%;padding:10px;border-radius:12px;border:1px solid #3d5aa6;background:#11305e;color:#fff;font-weight:800;cursor:pointer;margin-top:10px}
  </style>
</head>
<body>
